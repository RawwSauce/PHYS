...
void loop()
{
  ...
  analogWrite(motor1_enablePin, 235);//Je set le moteur 1, 255 = vitesse max on peut changer la vitesse si on veut
  analogWrite(motor2_enablePin, 235);//Je set le moteur 2, 255 = vitesse max
 ...
 /*
  ...
  {
    analogWrite(motor1_enablePin, 250);
    analogWrite(motor2_enablePin, 250);
    digitalWrite(motor1_in1Pin, LOW);
    digitalWrite(motor1_in2Pin, HIGH);
    digitalWrite(motor2_in1Pin, HIGH);
    digitalWrite(motor2_in2Pin, LOW);
  ...
  if(distance2<=15)// infrarouge qui cheke le back
  {
    analogWrite(motor1_enablePin, 75);
